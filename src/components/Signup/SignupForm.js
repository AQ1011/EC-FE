    ...
    return (
        <Grid container style={{paddingTop:'5vh', maxWidth:'1080px'}}>
            ...
            <Grid item lg={12} className={classes.centerAlign}>
                ...
                <input type="text" onChange={(e) => setName(e.target.value)} className={classes.userInput}
                />
                <input type="text" onChange={(e) => setEmail(e.target.value)} className={classes.emailInput}
                />
            </Grid>
            <Grid item lg={12} className={classes.centerAlign}>
                <div className={classes.iconUser}>
                ...
                <input type="text" onChange={(e) => setPhoneNum(e.target.value)} className={classes.inputItem}
                />
            </Grid>
            <Grid item lg={12} className={classes.centerAlign}>
                ...
                <input placeholder="password" onChange={(e) => setPassword(e.target.value)} type="password" className={classes.inputItem}
            ...
            <Grid item lg={12} className={classes.centerAlign}>
                ...
                <input placeholder="confirm password" type="password" 
                    onChange={(e) => setConfirm(e.target.value)} className={classes.inputItem}
